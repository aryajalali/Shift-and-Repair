...
exam_datasets = ['Cars', 'RESISC45', 'EuroSAT', 'SVHN', 'GTSRB', 'MNIST', 'DTD', 'SUN397'] # SUN397 | Cars | RESISC45 | EuroSAT | SVHN | GTSRB | MNIST | DTD
model = 'ViT-B-32'
...
ralphas = get_merging_cofficients('tw_adamerging', 'Vit-B-32')

adamerge_model = model.model

adamerge_model.lambdas_raw = ralphas[0][1:]

merged_encoder = adamerge_model.get_image_encoder()
