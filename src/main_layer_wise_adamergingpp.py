...
for vector_ in selected_entries:
    ...
    ref_model = torch.load(pretrained_checkpoint, weights_only=False, map_location='cpu')
...
task_vectors = [
    TaskVector(pretrained_checkpoint, '/Samira/AdaMerging//checkpoints/'+'ViT-B-32'+'/'+dataset_name+'/finetuned.pt') for dataset_name in exam_datasets
]
...
ralphas = get_merging_cofficients('lw_adamergingpp', 'ViT-B-32')
